                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="ps-3">
                                            <p class="text-xs font-weight-bold mb-0">Election 1</p>
                                        </td>
                                        <td class="ps-3">
                                            <p class="text-xs font-weight-bold mb-0">22 Aug 2024</p>
                                        </td>
                                        <td class="ps-3">
                                            <span class="text-xs font-weight-bold mb-0">22 Aug 2024</span>
                                        </td>
                                        <td class="ps-3">
