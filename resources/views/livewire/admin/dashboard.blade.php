          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Organization</p>
                    <h5 class="font-weight-bolder mb-0">
                      {{ $organizationCount }}
                    </h5>
                  </div>
        ...
        <div class="col-12">
          ...
          <div class="card-header py-4 px-3">
                            <div class="d-flex flex-row justify-content-between">
                                ...
                                <a href="{{ route('result') }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">
                                    <i class="fa-solid fa-file-lines me-2 btn-add"></i>View More
                                </a>
                            </div>
                        </div>
